	...
	function CommonMasterDataResults (COMMON_MASTER_CONFIG, CommonMasterDataUtil) {
		...
		var getMasterDataResults = function(masterData) {
			return CommonMasterDataUtil.getMasterDataValues(masterData, [COMMON_MASTER_CONFIG.CUSTOMER_TYPE, COMMON_MASTER_CONFIG.INDUSTRIES, COMMON_MASTER_CONFIG.ADDRESS_TYPES,
				...
				COMMON_MASTER_CONFIG.CV_APPROVE_REASONS, COMMON_MASTER_CONFIG.CV_REJECT_REASONS, COMMON_MASTER_CONFIG.WAIVE_OFF_APPR_REASONS, COMMON_MASTER_CONFIG.WAIVE_OFF_REJECT_REASONS,
				COMMON_MASTER_CONFIG.TELEPHONE_CATEGORIES, COMMON_MASTER_CONFIG.TELEPHONE_SELECTIONS, COMMON_MASTER_CONFIG.INSTALLATION_TYPES]);
		};
		...
		var getDefaultValues = function(masterData) {
			return CommonMasterDataUtil.getMasterDataDefault(masterData, [COMMON_MASTER_CONFIG.CUSTOMER_TYPE, COMMON_MASTER_CONFIG.INDUSTRIES, COMMON_MASTER_CONFIG.ADDRESS_TYPES,
				...
				COMMON_MASTER_CONFIG.LANDLORD_DESIGNATION, COMMON_MASTER_CONFIG.CV_APPROVE_REASONS, COMMON_MASTER_CONFIG.CV_REJECT_REASONS, COMMON_MASTER_CONFIG.WAIVE_OFF_APPR_REASONS, COMMON_MASTER_CONFIG.WAIVE_OFF_REJECT_REASONS,
				COMMON_MASTER_CONFIG.TELEPHONE_CATEGORIES, COMMON_MASTER_CONFIG.TELEPHONE_SELECTIONS, COMMON_MASTER_CONFIG.INSTALLATION_TYPES]);
		};
