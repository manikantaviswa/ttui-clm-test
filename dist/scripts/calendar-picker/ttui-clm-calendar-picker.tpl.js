...
$templateCache.put('scripts/calendar-picker/views/calendar-picker.tpl.html',
    ...
    "\n" +
    "            }\"></mwl-calendar></div><div class=\"col-md-12 pl-0\"><div class=\"col-sm-12 pr-0\"><ul class=\"list-group event-list\"><li class=\"list-group-item\" ng-repeat=\"slot in selectedSlots\" ng-click=\"onSlotClick(slot)\" ng-class=\"{'active': activeSlot === slot}\">{{slot.startsAt | date: 'hh:mm'}} - {{slot.endsAt | date: 'hh:mm'}}</li></ul></div></div></div>"
  );
