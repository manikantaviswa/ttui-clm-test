...
module.controller('simpleTimelineCtrl', ['$scope', '$rootScope', '$modal', function($scope, $rootScope, $modal) {
				...
				'<div class="panel panel-default">' +
					...
					'<div class="panel-body">' +
						'<form>' +
							...
							'</div>' +
							'<div>Icon class (any icon class e.g. fa fa-check-circle-o, glyphicon glyphicon-ok-circle, your-icon-class, etc.)</div>' +
							'<div class="form-group">' +
							...
							'<div class="input-group">' +
								'<input class="form-control" type="text" placeholder="dd/mm/yyyy" name="timelineDatepicker" data-autoclose="1" ng-model="timeline.event.time" bs-datepicker required />' +
	...
	$scope.testOptions = {
		hideLine: false,
		hideEventBubble: false,
		showEndBadge: true,
		showMoreBadge: true,
		showDateFilter: false,
		showContentFilter: true,
		clipEventContent: false,
